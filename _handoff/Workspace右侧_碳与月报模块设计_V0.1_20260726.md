...
> - **正确方向：** 与「数据填报」「ESG智能助手」同级的 **顶层独立页**  
> - **继任设计：** `_handoff/碳与月报独立页设计_V0.1_20260726.md`  
> - **继任开工令：** `_handoff/Trae实施任务单_碳与月报独立页_V1.0_20260726.md`  
>
...
| **非范围** | （历史） |
| **实施依据** | ~~`_handoff/Trae实施任务单_Workspace右侧碳与月报_V1.0_20260726.md`~~ → 同批 **SUPERSEDED** |
...
**下一步：** Trae 按 `_handoff/Trae实施任务单_Workspace右侧碳与月报_V1.0_20260726.md` 实施；口径变更须先改本设计再开工。
