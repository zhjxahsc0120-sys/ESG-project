...
export const masterKpiGroups: MasterKpiGroup[] = [
  {
    ...
    items: [
      ...
      { key: 'E04', label: '项目累计碳排放', fullName: '项目累计碳排放', value: 12856, unit: 'tCO₂e' },
    ],
  },
  {
    key: 'S',
    ...
    items: [
      ...
      { key: 'S03', label: '未办结劳务纠纷', fullName: '当前未办结劳务用工纠纷事项数', value: 4, unit: '项' },
  ...
  },
  {
    ...
    theme: 'purple',
    items: [
      { key: 'G01', label: '未完成合规手续', fullName: '当前未完成法定报批报建事项数', value: 5, unit: '项' },
      { key: 'G02', label: '许可临期及逾期', fullName: '当前临期及逾期许可事项数', value: 5, unit: '项' },
      { key: 'G03', label: '未关闭整改事项', fullName: '当前未关闭检查整改事项数', value: 6, unit: '项' },
...
export const carbonMetrics: CarbonMetric[] = [
  { key: 'cc1', label: '项目累计碳排放', value: 12856, unit: 'tCO₂e' },
